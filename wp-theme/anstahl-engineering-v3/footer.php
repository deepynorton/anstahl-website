...
<footer class="site-footer" role="contentinfo">
	...
	<div class="site-footer__bottom container">
		...
		<ul class="site-footer__legal">
			<li><a href="#"><?php esc_html_e( 'Privacy', 'anstahl-engineering' ); ?></a></li>
			<li><a href="#"><?php esc_html_e( 'Terms', 'anstahl-engineering' ); ?></a></li>
			<li><a href="#"><?php esc_html_e( 'Compliance', 'anstahl-engineering' ); ?></a></li>
		</ul>
	</div>
</footer>
